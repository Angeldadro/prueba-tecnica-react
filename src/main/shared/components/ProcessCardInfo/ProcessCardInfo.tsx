...
import { validatePayment } from '../../../../stores/CheckoutSlice';
...
export default function ProcessCardInfo({ item, isOpen, setIsOpen, fee }: ProcessCardInfo) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (transaction.paymentDetails.cardNumber === '' || transaction.paymentDetails.cvv === '' || transaction.paymentDetails.expiryMonth === '' 
            || transaction.paymentDetails.expiryYear === ''
        ) {
            dispatcher(addNotificationWithTimeout({
                message: 'All fields are required',
                type: 'error'
    ...
    return createPortal(
        <dialog className={`process-main ${isOpen ? 'active' : ''}`} onClick={handleCloseModal}>
            <div className={`process-modal ${isOpen ? 'active' : ''}`} onClick={(e) => {e.stopPropagation()}}>
                <div className='title-transaction'>
                    <p>You're about to pay <strong>{(item.price ? item.price + fee : item.price)?.toFixed(2)} USD</strong></p>
                ...
                <form className='form-payment' onSubmit={handleSubmit}>
                    <div className='form-payment-cn'>
                        ...
                        <div className='form-credit-card-info'>
                            ...
                            <div className='form-card-data'>
                                <div className='form-29ef0569e044'>
                                    <input type="text" placeholder='1234 5678 9101 1123' name='card-number'
                                    onChange={(e) => 
                        ...
                        <div className='form-field'>
                            ...
                            <input type="zip-code" required placeholder='00000'
                            onChange={(e) => 
                                setTransaction({ ...transaction, 
                                    shippingAddress: {
                        ...
                        <div className='form-field'>
                            ...
                            <input type="text" required placeholder='Street, Apartment...' name='street'
                            onChange={(e) => 
                                setTransaction({ ...transaction, 
                                    shippingAddress: {
